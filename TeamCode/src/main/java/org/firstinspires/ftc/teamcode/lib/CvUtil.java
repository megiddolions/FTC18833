...
public final class CvUtil {
     ...
     */
    public static  void hsvThreshold(Mat input, double[] hue, double[] sat, double[] val,
                              Mat out) {
     ...
     */
    public static  void mask(Mat input, Mat mask, Mat output) {
     ...
     */
    public static void filterContours(List<MatOfPoint> inputContours, double minArea,
     ...
     */
    public static void cvBitwiseOr(Mat src1, Mat src2, Mat dst) {

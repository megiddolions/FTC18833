...
public class AlignPowerShootsCommand extends CommandBase {
    ...
    private final BluePowerShootsAlignPipeLine.PowerShoot target;


    public AlignPowerShootsCommand(TankDrive driveTrain, VisionSubsystem vision, BluePowerShootsAlignPipeLine.PowerShoot target) {
